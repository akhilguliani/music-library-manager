...
The **Analysis** tab in the [Desktop Application](Desktop-Application) provides 3 sub-tabs with real-time streaming results:
...
See [CLI Commands](CLI-Commands) for the full command reference and [Mood Analysis Research](Mood-Analysis-Research) for model comparison details.
