...
**Integration effort:** Medium. Would need a new analysis module wrapping the HuggingFace model, plus a valence/arousal-to-mood mapper.

**Links:**
- [Music2Emo on HuggingFace](https://huggingface.co/amaai-lab/music2emo)
- [Music2Emo Demo](https://huggingface.co/spaces/amaai-lab/music2emo)
- [Paper: arXiv:2502.03979](https://arxiv.org/abs/2502.03979)
- [GitHub](https://github.com/AMAAI-Lab/Music2Emotion)
- [Awesome MER (curated list)](https://github.com/AMAAI-Lab/awesome-MER)
...
- `laion/larger_clap_music` model trained specifically on music data
...
- Not specifically trained for mood classification

**Best use:** As a fallback or for custom/flexible mood categorization beyond our 7 canonical moods.

**Links:**
- [LAION CLAP GitHub](https://github.com/LAION-AI/CLAP)
- [larger_clap_music on HuggingFace](https://huggingface.co/laion/larger_clap_music)
- [Paper: arXiv:2206.04769](https://arxiv.org/abs/2206.04769)
...
**Strengths:**
- Best general-purpose music embeddings available
- Captures tonal, harmonic, and rhythmic features
- Used as backbone in Music2Emo
- Good for fine-tuning on custom mood datasets

**Weaknesses:**
- Requires fine-tuning a classification head (no out-of-the-box mood predictions)
- GPU required for practical inference
- Need labeled training data for your specific mood taxonomy
...
- Easy to use (`pip install musicnn`)
- Pre-trained on MagnaTagATune (19k songs) and Million Song Dataset (200k songs)
- Predicts ~50 tags covering genres, instruments, moods

**Weaknesses:**
- Older model (2019), surpassed by newer approaches
- Python 3.6-3.9 compatibility issues reported
- Tags include moods but not as primary classification target
- TensorFlow 1.x dependency (compatibility issues with modern TF)

**Links:**
- [MusicNN GitHub](https://github.com/jordipons/musicnn)
- [Paper: arXiv:1909.06654](https://arxiv.org/abs/1909.06654)
- [MusicNN on PyPI](https://pypi.org/project/musicnn/)
